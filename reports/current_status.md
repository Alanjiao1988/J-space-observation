...
> binds the last, so a decorator, a module-level rebinding or a second
> definition could have shipped every chunk elsewhere and still passed. The
> check now refuses any source in which that name is defined more than once,
> rebound, decorated, shadowed, or nests a scope. That is a
