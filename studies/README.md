...
The repository contains two scientifically distinct studies. This index is an
...
| [Study 2](study2/README.md) | Single-forward behavioral and causal test of task-defined intermediate computation with base and instruction controls | `OPEN_AWAITING_STAGE_P` | No empirical result |
