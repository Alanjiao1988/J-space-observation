...
>
> **Generation 3 is current.** Its active lock is
> `studies/study3/pilot/p0_r1/p0_r1_execution_lock_v3.json` (31,025 bytes,
> sha256 `f219a472705dec4e5c590614d392f39c9ec672d45397471632ad951d69097794`,
> 43 bound executable paths), pinned to image digest
...
> recursive-manifest, hard-kill and CPU recovery canaries passed. Clean ACR
> validation returned 4,585 passes, 15 skips and only the two registered
> historical failures.
>
> Generations 1 and 2 are superseded **without consumption**: zero executions,
> GPU allocations, tokenizer constructions/encodes, checkpoint downloads and
> weight loads. Their locks, images and handoffs are preserved byte-identically.
>
...
> [P0-R1 handoff, generation 3, current](pilot/p0_r1/P0_R1_HANDOFF_V3.md) ·
> [P0-R1 handoff, generation 2, history](pilot/p0_r1/P0_R1_HANDOFF_V2.md) ·
